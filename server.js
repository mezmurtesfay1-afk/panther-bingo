...
function startTelegramBot(){
  const TOKEN=process.env.BOT_TOKEN, GAME_URL=process.env.GAME_URL||'https://panther-bingo.onrender.com';
  ...
  bot.on('message', async msg => {
    ...
    if(text === '🎮 Play Now'){
      ...
      bot.sendMessage(msg.chat.id, `🎮 Tap below to open the game:`, {
        reply_markup:{
          inline_keyboard:[[{ text:'🎮 Play Panther Bingo', web_app:{ url:`${GAME_URL}?tid=${tid}` }}]]
        }
      });
    }
